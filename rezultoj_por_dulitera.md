# Komparo de du Tengvar‑reĝimoj por Esperanto: KV kontraŭ VK

*Min delonge jukis la demando* pri du variantoj por skribi Tengvaron. Citaĵo *el* Sergio Pokrovskij en artikolo pri la ŝava alfabeto ([https://kovro.heliohost.org/eo/tools/Sxava/sxava.html](https://kovro.heliohost.org/eo/tools/Sxava/sxava.html)):
...
Ekzemple, la artikolo *la* estas `LA` en KV‑varianto, sed `yL-Ax` en VK. Male la prepozicio *al* estas `xA-Ly `en KV varianto, kaj simple `AL` en VK. Iuj vortoj estas pli longaj uzante KV, aliaj male pli longaj uzante VK; iuj havas la saman kvanton da silaboj en ambaŭ variantoj.
...
- 23×5: realaj paroj (KV aŭ VK)

- 5: kombinoj kun x (xV aŭ Vx) – vokaloj sen konsonanto

- 23: kombinoj kun y (Ky aŭ yK) – konsonantoj sen vokalo
...
**Por kovri 50 % de la teksto:**

- **VK** bezonas nur **13** diversajn silabojn:  
`Ix, yT, Ax, yL, Ox, yK, Ex, yD, yR, yP, yS, ON, AJ`

- **KV** bezonas **16** silabojn:  
`Ny, Sy, Jy, LA, xA, xE, Ry, DE, TA, KA, Ly, LI, TI, xO, TO, RO`

**Por kovri 80 % kaj 90 % de la teksto:**

- **VK**: 33 kaj 52 diversaj silaboj

- **KV**: 44 kaj 63 diversaj silaboj

Do la varianto **VK estas pli efika** rilate al la nombro de diversaj silaboj necesaj por legi la plej grandan parton de la teksto. **Ĝi **estas je 20% pli ŝpara.
...
- *Teorie ekzistas 143 eblaj duliteraj silaboj; en granda Esperanta tekstaro reale aperas preskaŭ ĉiuj.*

- *La KV‑varianto donas entute 10 % malpli da silaboj ol VK kaj 36 % malpli da signoj ol la plena alfabeto.*

- *La VK‑varianto havas pli favoran distribuon de la plej oftaj silaboj: por kovri 80 % de la teksto necesas ĉirkaŭ 20% malpli da diversaj silabosignoj ol la KV-varianto.*

- *Elekti inter la du reĝimoj estas elekti inter teksta koncizeco (KV) kaj silabara kompakteco (VK). Por Esperanto, KV profitas de la fakto ke vortoj pli ofte komenciĝas per konsonanto kaj finiĝas per vokalo.*
...
- *Tengvaro en la Esperanta Vikipedio:* [https://eo.wikipedia.org/wiki/Tengvaro](https://eo.wikipedia.org/wiki/Tengvaro)

- *Ĝenerala priskribo de la Tengvar‑modoj en la angla Vikipedio:* [https://en.wikipedia.org/wiki/Tengwar\#Modes](https://en.wikipedia.org/wiki/Tengwar#Modes)

- *Tengvar‑modo por Esperanto en Omniglot:* [https://www.omniglot.com/conscripts/tengwar\_esperanto.htm](https://www.omniglot.com/conscripts/tengwar_esperanto.htm)

- *Detala studo pri Tengvar‑modoj (Amanye Tenceli):* [https://at.mansbjorkman.net/](https://at.mansbjorkman.net/)
